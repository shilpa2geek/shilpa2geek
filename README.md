...
* **12+ Years of Experience:** Expertise in analysis, design, development, testing, and maintenance of 10+ production-grade mobile applications.
* **Modern Android Stack:** Deep knowledge of **Kotlin**, **Jetpack Compose**, **Coroutines**, **Flow**, and **Dagger-Hilt**.
* **Cross-Platform Expertise:** Hands-on experience with **Flutter** and **React Native** (TypeScript/Redux).
* **Architecture:** Proficient in **MVVM**, **Clean Architecture**, and **Modular Development** following SOLID principles.
* **Specialized Integrations:** Extensive experience with **Bluetooth (BLE)**, location services, and secure authentication (OAuth 2.0, SSL/TLS).
* **CI/CD & DevOps:** Skilled in automating workflows using **Jenkins**, **Fastlane**, **GitHub Actions**, and **Bitrise**.
...
## 📫 Connect with me
[LinkedIn](https://www.linkedin.com/in/shilpas1578468/) | [Portfolio/Contact](mailto:shilpa.geek@gmail.com) | +1 (940) 487 7258
